  ...
  const saveReservation = () => {
    ...
    const isReserved = reservations.data
      ...
      .some((item: any) => {
        ...
        // check if the room is reserved between the ckeck in and check out dates
    ...
    <div>
      <div className='bg-tertiary h-[320px] mb-4'>
        ...
        <div className='flex flex-col gap-4 w-full py-6 px-8'>
          ...
          {/* conditional rendering of the booking button based on an user authentication status. if the user is authenticated, display a "Book now" button with an onClick event handler to save the booking.
